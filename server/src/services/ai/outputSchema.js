...
// Empty insights are valid: the model may honestly find nothing to say yet
// (thin evidence) while still returning a useful reminder. min() is
// deliberately absent — NEVER force confabulation to fill an array.

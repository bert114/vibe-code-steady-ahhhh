...
describe('ai output contract (no db)', () => {
  ...
  it('accepts honestly empty insights with a reminder (thin evidence)', () => {
    // Observed live 2026-09-19: the model returned no insights but a
    // "need more data" reminder. Forcing min(1) turned that honesty into a
    // fallback and dropped the reminder — never punish it.

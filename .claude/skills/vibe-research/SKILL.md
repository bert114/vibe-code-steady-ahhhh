...
- Source files: research-Steady-Ahh.md
```
...
Then write the research findings to `docs/research-Steady-Ahh.md` in the project directory.
...
> Your research is saved to `docs/research-Steady-Ahh.md`.
>

...
- Current task: AI Insights complete — analyze pipeline + Insights page verified (fallback + rate-limit live; real model call deferred); next is Boundary/Dashboard polish + validation readiness (Weeks 9–12)
